...
Touched by Mel is a business that propvides beauty services where users can create an account, book a with the artist, read services offered and view the food and drinks menu.
<hr>
...
- To view make up services, contact info & booking

### Site Owner Goals

- To provide a solution to allow users to book a make up service online
...
### Target Audience
- Users that wish to book a make up service for one or more persons
- Past and new customers for the business
- Models and fashion industry profressionals
- Beauty enthusiast and influencers
...
I chose earthy colours to market a product to stand out.
Light colours are popular in the make up and skincare industry so I wanted to keep the tone of themes.

The colors I wanted to stay close to  [Coolors.co](https://coolors.co/)
<details><summary>See colour pallet</summary>
<img src="static/images/colours-pallet.png">
</details>

### Fonts

 The fonts selected were from Google Fonts, Roboto and sans-serif as a backup font.

### Structure

#### Website pages

The site was designed for the user to be familiar with the layout such as a navigation bar along the top of the pages and sanswich menu button to consist simplicity for users.

The footer includes all the business's social media links, allowing users to visit and follow the business on any platform, helping to grow its followers, likes, and shares.

- The site consists of the following pages:
  - Homepage with slideshow for the user to view the website, and see the artists previous work
  - About has a brief explanation to who the artist is and about them
  - Services age has the current list of all available packages and a contact form asking for the service, name,     email, phone, date requested, a message and a submit button
  ...
  - Contact page allows new and registered users to book a make up service, name, email and a message and submit button
...
##### Services Model
The Services Model contains the following:
- dservice_id int [primary key]
